...
public class MyPelemUpcomingLoader extends AsyncTaskLoader<LinkedList<Pelem>> {
    ...
    public MyPelemUpcomingLoader(@NonNull Context context) {
        super(context);
    ...
    public LinkedList<Pelem> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=" + BuildConfig.TMDB_KEY + "" +
                "&language=" + getContext().getString(R.string.language);
