...
public class MyPelemNowPlayingLoader extends AsyncTaskLoader<LinkedList<Pelem>> {
    ...
    public MyPelemNowPlayingLoader(@NonNull Context context) {
        super(context);
    ...
    public LinkedList<Pelem> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/movie/now_playing?api_key=" + BuildConfig.TMDB_KEY +
                "&language=en-us";//+getContext().getString(R.string.language);
