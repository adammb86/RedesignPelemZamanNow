package com.example.adammb.redesignpelemzamannow.screen.upcoming;
...
import com.example.adammb.redesignpelemzamannow.data.loader.MyPelemUpcomingLoader;
 ...
 */
public class UpcomingFragment extends Fragment implements LoaderManager.LoaderCallbacks<LinkedList<Pelem>> {
    ...
    public Loader<LinkedList<Pelem>> onCreateLoader(int id, @Nullable Bundle args) {
        return new MyPelemUpcomingLoader(getActivity());
