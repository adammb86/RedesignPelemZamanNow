package com.example.pelempavorit.data;

import android.database.Cursor;
import android.os.Parcel;
import android.os.Parcelable;

import com.example.pelempavorit.db.DatabaseContract;

import static android.provider.BaseColumns._ID;
import static com.example.pelempavorit.db.DatabaseContract.getColumnDouble;
import static com.example.pelempavorit.db.DatabaseContract.getColumnInt;
import static com.example.pelempavorit.db.DatabaseContract.getColumnString;
...
public class Pelem implements Parcelable {
    ...
    public static final Creator<Pelem> CREATOR = new Creator<Pelem>() {
        @Override
